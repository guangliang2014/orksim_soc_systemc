...
#include "bitutils.c"
extern inline void  set( volatile unsigned char *reg,
		           unsigned char  flag );

extern inline void  clr( volatile unsigned char *reg,
		           unsigned char  flag );

extern inline int  is_set( volatile unsigned char  reg,
		             unsigned char  flag );

extern inline int  is_clr( volatile unsigned char  reg,
		             unsigned char  flag );
