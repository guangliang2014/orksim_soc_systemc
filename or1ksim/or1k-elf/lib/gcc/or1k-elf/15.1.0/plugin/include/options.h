...
enum opt_code
{
  ...
  OPT_main = 2038,                           /* -main */
  OPT_main_ = 2039,                          /* -main= */
  OPT_mboard_ = 2040,                        /* -mboard= */
  OPT_mcmodel_ = 2041,                       /* -mcmodel= */
  OPT_mcmov = 2042,                          /* -mcmov */
  OPT_mdouble_float = 2043,                  /* -mdouble-float */
  OPT_mhard_div = 2044,                      /* -mhard-div */
  OPT_mhard_float = 2045,                    /* -mhard-float */
  OPT_mhard_mul = 2046,                      /* -mhard-mul */
  OPT_mnewlib = 2047,                        /* -mnewlib */
  OPT_mror = 2048,                           /* -mror */
  OPT_mrori = 2049,                          /* -mrori */
  OPT_msext = 2050,                          /* -msext */
  OPT_msfimm = 2051,                         /* -msfimm */
  OPT_mshftimm = 2052,                       /* -mshftimm */
  OPT_msoft_div = 2053,                      /* -msoft-div */
  OPT_msoft_float = 2054,                    /* -msoft-float */
  OPT_msoft_mul = 2055,                      /* -msoft-mul */
  OPT_munordered_float = 2056,               /* -munordered-float */
  OPT_n = 2057,                              /* -n */
  OPT_name_sort = 2058,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2059,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2060,              /* -no-integrated-cpp */
  OPT_no_pie = 2061,                         /* -no-pie */
  OPT_nocpp = 2062,                          /* -nocpp */
  OPT_nodefaultlibs = 2063,                  /* -nodefaultlibs */
  OPT_nolibc = 2064,                         /* -nolibc */
  OPT_nomain = 2065,                         /* -nomain */
  OPT_nophoboslib = 2066,                    /* -nophoboslib */
  OPT_nostartfiles = 2067,                   /* -nostartfiles */
  OPT_nostdinc = 2068,                       /* -nostdinc */
  OPT_nostdinc__ = 2069,                     /* -nostdinc++ */
  OPT_nostdlib = 2070,                       /* -nostdlib */
  OPT_nostdlib__ = 2071,                     /* -nostdlib++ */
  OPT_o = 2072,                              /* -o */
  OPT_objects = 2073,                        /* -objects */
  OPT_p = 2074,                              /* -p */
  OPT_pass_exit_codes = 2075,                /* -pass-exit-codes */
  /* OPT_pedantic = 2076, */                 /* -pedantic */
  OPT_pedantic_errors = 2077,                /* -pedantic-errors */
  OPT_pg = 2078,                             /* -pg */
  OPT_pie = 2079,                            /* -pie */
  OPT_pipe = 2080,                           /* -pipe */
  OPT_preprocess = 2081,                     /* -preprocess */
  OPT_print_file_name_ = 2082,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2083,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2084,          /* -print-multi-directory */
  OPT_print_multi_lib = 2085,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2086,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2087,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2088,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2089,               /* -print-prog-name= */
  OPT_print_search_dirs = 2090,              /* -print-search-dirs */
  OPT_print_sysroot = 2091,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2092,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2093,                    /* -print-value */
  OPT_quiet = 2094,                          /* -quiet */
  OPT_r = 2095,                              /* -r */
  OPT_remap = 2096,                          /* -remap */
  OPT_reverse_sort = 2097,                   /* -reverse-sort */
  OPT_s = 2098,                              /* -s */
  OPT_save_temps = 2099,                     /* -save-temps */
  OPT_save_temps_ = 2100,                    /* -save-temps= */
  OPT_shared = 2101,                         /* -shared */
  OPT_shared_libgcc = 2102,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2103,               /* -shared-libphobos */
  OPT_size_sort = 2104,                      /* -size-sort */
  /* OPT_specs = 2105, */                    /* -specs */
  OPT_specs_ = 2106,                         /* -specs= */
  OPT_static = 2107,                         /* -static */
  OPT_static_libasan = 2108,                 /* -static-libasan */
  OPT_static_libgcc = 2109,                  /* -static-libgcc */
  OPT_static_libgcobol = 2110,               /* -static-libgcobol */
